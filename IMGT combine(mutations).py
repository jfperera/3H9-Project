...
#list1 = [('O1-SP' , 8)]
for item in list1:
    file1 = open('/Users/haochuhuang/Documents/Jason Perera/3H9 BCR HTS Sequencing/compile IMGT Mutation/' + item[0] +'.txt', 'w')
    file2 = open('/Users/haochuhuang/Documents/Jason Perera/3H9 BCR HTS Sequencing/ALL IMGT/' + item[0] + '_C-' + str(1) + '/8_V-REGION-nt-mutation-statistics_'+ item[0] + '_C-' + str(1) + '_091113.txt', 'r')
    for line in file2:
        file1.write(line)
    file2.close()    
    for i in range(2, item[1]+1):
        file2 = open('/Users/haochuhuang/Documents/Jason Perera/3H9 BCR HTS Sequencing/ALL IMGT/' + item[0] + '_C-' + str(i) + '/8_V-REGION-nt-mutation-statistics_'+ item[0] + '_C-' + str(i) + '_091113.txt', 'r')
