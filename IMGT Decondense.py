...
#list1 = ['O1-SP']
for item in list1:
    file1 = open('/Users/haochuhuang/Documents/Jason Perera/3H9 BCR HTS Sequencing/DC IMGT Summary/' + item +'.txt', 'w')
    file2 = open('/Users/haochuhuang/Documents/Jason Perera/3H9 BCR HTS Sequencing/compile IMGT Summary/' + item + '.txt', 'r')
    file2.readline()
    for line in file2:
        if line != '':
